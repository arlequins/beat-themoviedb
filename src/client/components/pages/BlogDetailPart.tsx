...
const BlogDetailPart: React.FC<AllProps> = () => {
  ...
  const detail = movieDetails.result
	...
	return (
      ...
      <MainFeaturedPost title={detail.title} imgUri={detail.poster_path ? `${env.CDN_URI}${detail.poster_path}` : NO_IMAGE } overview={detail.overview ? detail.overview : ''}
      ...
      { detail.homepage && (
        <div className={classes.heroContent}>
          <Container maxWidth="md">
            <Typography variant="h5" align="center" color="textPrimary" className={classes.taglineContent}>
              {detail.tagline}
            </Typography>
            <div>
